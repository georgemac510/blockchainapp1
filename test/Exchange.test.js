...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
	...
	describe('withdrawing Ether', async () => {
		...
		describe('failure', async () => {
			it('reject withdraws for insufficient balances', async () => {
	...
	describe('withdrawing tokens', async () => {
		...
		describe('failure', async () => {
			it('reject withdrwas for insufficient balance', async () => {
			...
			it('reject withdraws of ether', async () => {
	...
	describe('checking balances', async () => {
		...
		beforeEach(async () => {
			amount = ether(1)
			exchange.depositEther({ value: amount, from: user1 })
		})
